...
serialInclude(['../lib/CGF.js', './src/XMLscene.js', './src/MySceneGraph.js', './src/MyInterface.js', './src/primitives/MyRectangle.js',
                 ...
                 './src/animation/Keyframe.js', './src/animation/Animation.js', './src/animation/KeyframeAnimation.js', './src/spritesheet/MySpritesheet.js',
                  ...
                  './src/MyCameras.js', './src/game/MyGameOrchestrator.js', './src/game/MyTile.js', './src/game/MyPiece.js', './src/game/MyScorePiece.js', './src/game/MyGameBoard.js',
                  ...
                  './src/animation/PieceAnimation.js', './src/game/MyGameElements.js', './src/primitives/objects/CGFOBJModel.js', './src/primitives/objects/CGFResourceReader.js',
                  './src/animation/KeyframeLoopAnimation.js',
